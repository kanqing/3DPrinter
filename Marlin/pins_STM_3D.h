#ifndef __PIN_STM_3D_H__
#define __PIN_STM_3D_H__
...
#define X_MIN_PIN           PIN_VAL('I',13)
#ifndef X_MAX_PIN
  #define X_MAX_PIN         -1
#endif

#define Y_MIN_PIN           PIN_VAL('G',7)
#define Y_MAX_PIN           -1

#define Z_MIN_PIN           PIN_VAL('G',6)
#define Z_MAX_PIN           -1
